...
def main():
    ...
    try:
        [print(x.value, end=" ") for x in topological_ordering([five, four, three, two, one, zero])]
    except Exception as e:
        print(e)
    print()
    ...
    try:
        [print(x.value, end=" ") for x in topological_ordering([milk, egg, oil, mix, griddle, syrup, pour, turn, eat])]
    except Exception as e:
        print(e)
    print()
